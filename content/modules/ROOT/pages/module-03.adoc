...
.changed
image::../assets/images/changedpermissionstatussh.png[changed]
...
.success
image::../assets/images/successfullyexecutedasguest.png[success]
...
.cat
image::../assets/images/catstatussh.png[cat]
