...
.status script run
image::../assets/images/statusscriptrun.png[status script run]
...
.srv guest
image::../assets/images/srvguest.png[srv guest]
...
.denied!
image::../assets/images/permissiondeniedasguest.png[denied!]
