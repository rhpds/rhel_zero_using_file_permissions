...
.status script run
image::../assets/images/statusscriptrun-zt.png[status script run]
...
.srv rhel
image::../assets/images/srvguest-zt.png[srv rhel]
...
.denied!
image::../assets/images/permissiondeniedasguest-zt.png[denied!]
